...
(function () {
  ...
  */
  ...
  k.fc = function () {
    for (var a; a = Nc(this);) Oc(this, a, this.a, this.h);
  ...
  */
  ...
  function bk(a) {
    ...
    Rj(a.m, function (b) {
      ...
      if (b && b.authEvent) {
        ...
        for (c = 0; c < a.i.length; c++) d = a.i[c](b) || d;
  ...
  function vl(a) {
    ...
    for (d = c = 0; d < b.h; d++) for (var e = 24; 0 <= e; e -= 8) a[c++] = b.a[d] >> e & 255;
  ...
  function Rn(a) {
    if (a.ba) {
      for (var b = 0; b < a.u.length; b++) if (a.u[b]) a.u[b](Vn(a));

      if (a.X !== a.getUid() && a.P.length) for (a.X = a.getUid(), b = 0; b < a.P.length; b++) if (a.P[b]) a.P[b](Vn(a));
    }
  }
  ...
  k.clear = function () {
    ...
    for (var a = 0; a < this.i.length; a++) this.i[a].cancel("RecaptchaVerifier instance has been destroyed.");
...
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/auth.esm.js"}],"firebase/firebaseConfig.js":[function(require,module,exports) {
"use strict";
...
var firebaseConfig = {
  apiKey: "AIzaSyDC3U_lkeBLVzniZ22Xo8S6O0vDmSROxhU",
  authDomain: "fir-practice-17cc0.firebaseapp.com",
  projectId: "fir-practice-17cc0",
  storageBucket: "fir-practice-17cc0.appspot.com",
  messagingSenderId: "754563504335",
  appId: "1:754563504335:web:835d7e95c30cb9772ebfba"
};
exports.firebaseConfig = firebaseConfig;
},{}],"firebase/firebaseInitialize.js":[function(require,module,exports) {
"use strict";
...
var firebaseApp = _app.default.initializeApp(_firebaseConfig.firebaseConfig);

exports.firebaseApp = firebaseApp;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","./firebaseConfig":"firebase/firebaseConfig.js"}],"firebase/firebaseAuthentication.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.googleSignout = exports.googleSignin = void 0;

var _app = _interopRequireDefault(require("firebase/app"));

require("firebase/auth");

var _firebaseInitialize = require("./firebaseInitialize");
...
var googleSignin = function googleSignin() {
  ...
  _app.default.auth().signInWithPopup(provider).then(function (result) {
    ...
    return console.error('There was an error when signing in with Google: ', error);
  });
};
...
var googleSignout = function googleSignout() {
  _app.default.auth().signOut().then(function () {
    return console.log('User successfully signed out');
  }).catch(function (error) {
    return console.error('There was an error when signing out: ', error);
  });
};

exports.googleSignout = googleSignout;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js","./firebaseInitialize":"firebase/firebaseInitialize.js"}],"firebase/handleAuthStateChange.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleOnAuthStateChange = void 0;
...
var handleOnAuthStateChange = function handleOnAuthStateChange() {
...
exports.handleOnAuthStateChange = handleOnAuthStateChange;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _handleAuthStateChange = require("./firebase/handleAuthStateChange");

(0, _utilities.assignClick)('signin-google', _firebaseAuthentication.googleSignin);
(0, _utilities.assignClick)('signout-google', _firebaseAuthentication.googleSignout);
(0, _handleAuthStateChange.handleOnAuthStateChange)();
},{"./utilities":"utilities.js","./firebase/firebaseAuthentication":"firebase/firebaseAuthentication.js","./firebase/handleAuthStateChange":"firebase/handleAuthStateChange.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
